...
import pe.bvva.pruebatecnica.apitipocambio.security.RestAuthenticationEntryPoint;
import pe.bvva.pruebatecnica.apitipocambio.security.TokenAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().sessionManagement()
                ...
                .antMatchers("/usuario/login","/usuario/signup")
                .permitAll()
                .anyRequest()
                .authenticated();
